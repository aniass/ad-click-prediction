...
## General info
The aim of the project was the advertisement click prediction with  machine learning algorithms. Based on the historical data of advertisement clicks (user behaviour, user profile, etc.) I have made a model to predict who is going to click ad on a website in the future. The analysis includes data analysis, data preparation and prediction by different machine learning models such as Logistic Regression, Linear SVC, Decision Tree, Random Forest and AdaBoost. Finally the prediction model was built that can support internet  marketing decisions.
